...
//     document.write(`
//     <div>
//         <p>Name -- ${simpson.name}</p>
//         <p>Surname -- ${simpson.surname}</p>
//         <p>Age -- ${simpson.age}</p>
...
//     divMain.style.marginBottom = "50px";
...
//     divMain.append(monthDuration);
//
//     let hourDuration = document.createElement(`span`);
//     hourDuration.style.margin = "40px";
//     hourDuration.innerText = `HourDuration - ${coursesArrayElement.hourDuration}`;
//     divMain.append(hourDuration);
//
//     let ul = document.createElement("ul");
//
//     for (const modElement of coursesArrayElement.modules) {
//         let li = document.createElement("li");
//         li.innerText = `${modElement}`;
//         ul.append(li);
//     }
//     divMain.append(ul);
// }
...
//     div.innerText = `Title ${coursesAndDurationArrayElement.title}   MonthDuration ${coursesAndDurationArrayElement.monthDuration}`;
//     document.body.appendChild(div);
// }
...
//     h1.innerText = `Title - ${coursesAndDurationArrayElement.title}`;
//     div.append(h1);
//
...
//
// let boo = document.createElement(`button`);
// boo.innerText = `push`;
// boo.onclick = () => {
//     p.style.display = "none";
// }
//
// document.body.append(p, boo);
...
// boo.innerText = `push`;
//
// document.body.append(input, boo);
//
// boo.onclick = () => {
//     let val = input.value;
//     if (val < 18) {
...
// boo.innerText = `push`;
//
// document.body.append(in1,in2,in3,boo);
//
// boo.onclick = () => {
//     let tr = in1.value;
//     let td = in2.value;
